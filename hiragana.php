...
<!--			<a href="#!/lang-htl" id="item-lang-htl" class="menu-item panel-link invisible offscreen-item" title="Drill your recognition of hiragana words. Choose the english meaning.">
	...
	<div id="about-text" class="nothing">
		...
		<p>
			...
			<a href="">feedback@nihongodrills.com</a> or <a href="http://www.twitter.com/">Twitter</a>.
		</p>
	</div>
	<div id="links-text" class="nothing">
		...
		<p>
			If you require some guidance in learning how to speak or write this language there
