<div class="module" id="drill-char-vtw">
	...
	<canvas class="char-writing-canvas" width="100" height="100">
		<div class="char-writing-canvas-fail">
			Your browser does not support the writing canvas. You must use paper.
		</div>
	</canvas>
	<div class="random-char-holder covered">
	</div>
	<div></div>
	<div class="button-box inline">
		<button class="erase-button drill-button">Erase</button>
	</div>
	<div class="button-box inline">
		<button class="next-button">Show</button>
	</div>
	<div></div>
</div>
