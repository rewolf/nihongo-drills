...
<head>
   ...
   <!-- <meta name="fragment" content="!" /> -->
    <meta name="description" content="Shows some example images of how to use the Japanese name-tags to help memorise common household items such as in the bathroom." />
	<title>Nihongo Drills | Name Tags Example</title>
    <meta name="keywords" content="japanese,nihongo,practise,drill,memorise,pronounce,speak,learn" />
	<meta property="og:title" content="Nihongo Drills Name-tags Example" />
	<meta property="og:type" content="website" />
	<meta property="og:url" content="http://www.nihongodrills.com/name-tag-example.php" />
...
<body style="overflow:auto">
	<header id="layout-top" class="dark-panel">
		<a href="http://www.nihongodrills.com/#!/" id="header-title">「&nbsp;nihongo / にほんご / japanese&nbsp;」&nbsp;&nbsp; drills</a>
		<div id="header-links">
	...
	<p style="color:white;text-align:center;font-size:16px">
		Below are some images of Japanese name-tags (or labels) stuck to items in a bathroom.  Doing this
		can help you memorise the Japanese names for each item.
	</p>
	<div style="text-align:center">
		<a href="res/images/name-tag-example-01.jpg"><img src="res/images/name-tag-example-01.jpg" width="300" alt="Japanese name-tags or labels with Kanji, Hiragana and Katakana stuck on items in a bathroom" /></a>
		<a href="res/images/name-tag-example-02.jpg"><img src="res/images/name-tag-example-02.jpg" width="300" alt="Japanese name-tags or labels with Kanji, Hiragana andor labels stuck on items around a washbasin in a bathroom" /></a>
	</div>
</body>
</html>
